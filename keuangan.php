		 ...
		 <div class="col-md-5">
          ...
          <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch">
            <div class="content d-flex flex-column justify-content-center">
              <h2 data-aos="fade-up"><strong>Tupoksi - Sub Bagian Keuangan</strong></h2>
			  <hr />
			  ...
			  <p data-aos="fade-up">
				<p><ol><li>Penyusunan rencanadan program kerja anggaran Dinas
				</li>
					  <li>Pengelolaan adminitrasi keuangan dan pelayanan di bidang keuangan</li>
					   <li>Penyusunan laporan realisasi dan neraca keuangan Dinas</li>
					    <li>Pelaksanaan laporan Sub Bagian Keuangan</li>
              </p>
			  ...
			  <p data-aos="fade-up">
				<p><ol><li>Memimpin pelaksanaan tugas Sub Bagian Keuangan
				</li>
					  <li>Menyusun rencana kerja Sub Bagian Keuangan</li>
					   <li>Mendistribusikan pekerjaan dan memberi arahan pelaksanaan tugas kepada bawahan</li>
						...
						<li>Mengelola gaji dan tunjangan pegawai</li>
