		...
		<div class="row">
          ...
          <div class="col-lg-8 entries">
			...
			<?php
						...
						$sebelum        = $halaman - 1;
						$setelah        = $halaman + 1;
						$data = mysqli_query($koneksi,"select * from berita WHERE kategori='Kerajinan'");
						$jumlah_data    = mysqli_num_rows($data);
						$total_halaman  = ceil($jumlah_data / 3);
						$data = mysqli_query($koneksi,"select * from berita");
						$data_berita  = mysqli_query($koneksi, "select * from berita WHERE kategori='Kerajinan' limit $halaman_awal, 3");
