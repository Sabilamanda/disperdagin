...
<html>
<head>
<title>Halaman Data UMKM Dinkukmdagin</title>
<!-- datatable style -->
...
<body>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
		...
		<h1><strong>Data KOPERASI<br>Dinas Koperasi Usaha Kecil dan Menengah Perdagangan dan Perindustrian Kota bogor</strong></h1>
		<br><br><br>
		...
		<?php 
		$no = 1;
		$data = mysqli_query($koneksi,"select * from koperasi");
		while($row=mysqli_fetch_array($data)){
			?>
			<tr>
				<td><?php echo $no++; ?></td>
