      ...
      <div class="container">
		<div class="row">          
		 <div class="section-headline text-center">
           <h2><strong>TUGAS JABATAN - BIDANG PENGEMBANGAN PERDAGANGAN DALAM NEGERI, PERLINDUNGAN KONSUMEN DAN TERTIB NIAGA</strong></h2>
         </div>         
        </div>
		<br><br>
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                  <img src="assets/img/disperindag.jpeg" width="480px" height="490px" alt="">
