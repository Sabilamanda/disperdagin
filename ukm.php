        ...
        <div class="container">
		  ...
		  <li class="dropdown"><a href="#" id="navbarDropdownMenuLink"><span>Statistik</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
			  ...
			  <li><a href="ukm.php">Data PKL & UMKM</a></li>
			 </ul>
  ...
  <main id="main">
    ...
    <section id="about-us" class="about-us">
      <div class="container">
         ...
         <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-center">
            <div class="content d-flex flex-column justify-content-top">              
			  <center><h2><strong>Data PKL & UMKM</strong></h2> </center>
			  <center><h2><strong>Dinas Perdagangan dan Perindustrian</strong></h2> </center>
              <div class="col-md-5">
			<div class="col-md-5">
				<a href="http://kumkm.kotabogor.go.id/new/page.php?buka=umkm"><img src="assets/img/umkm.jpg">
