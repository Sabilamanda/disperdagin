                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Komentar</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
								...
								<tbody>
									...
									while ($row = mysqli_fetch_array($data)) { ?>	
										...
										<tr>
											...
											<td><?php echo $row['status_komentar'] == 1 ? "<span class='text-success'>Publish</span>" : "<span class='text-danger'>Tidak Dipublish</span>"; ?> </td>
										 <?php
										 
												echo"<td><a href=\"edit-komentar.php?id=$row[0]\"><button class='btn btn-primary btn-xs'>
													<i class='fa fa-pencil'></i></button></a></td>";
														echo"<td><a href=\"delete-komentar.php?id=$row[0]\"onclick=\"return confirm('Anda yakin akan menghapus data ini?')\">
