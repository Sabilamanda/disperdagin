...
?>       
	<html>
<body>
<title> Halaman Tambah IKM </title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                ...
                                                <form name="save-ikm" class="form-horizontal style-form" method="post" action="save-ikm.php" enctype="multipart/form-data" >
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
															...
															<input type="text" id="form-field-1" class="form-control" name="nama_toko"  required/>
                                                            </div>
                                                        </div>
                                     </div>
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<input type="text" id="form-field-1" class="form-control" name="nama_pemilik"  required/>
                                                            </div>
                                                        </div>
                                     </div>
									 ...
									 <div class="form-group-inner">
									  ...
									  <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<input type="text" id="form-field-1" class="form-control" name="jns_usaha"  required/>
                                                            </div>
                                                        </div>
                                     </div>									 
