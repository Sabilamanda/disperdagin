...
<head>
    ...
    <title>Halama Berita Dinkukmdagin</title>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x-editable-list">
							...
							<?php
								...
								<button type='button' class='btn btn-primary'><i class='fa fa-plus'></i> Tambah Berita</button>
									</a><br><br>";?>
                                <thead>
									<tr>
										<th>No</th>
									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
										 ...
										 <?php
												...
												echo"<td><a href=\"edit-berita.php?id=$row[0]\"><button class='btn btn-primary btn-xs'>
