...
<head>
    ...
    <title>Edit Data Dinkukmdagin</title>
...
<body>
   ...
   <div class="all-content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Berita</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <div class="single-product-tab-area mg-t-15 mg-b-30">
            ...
            <div class="container-fluid">
                <div class="row">
				  ...
				  $perintah_sql="select * from berita where id_berita=$id";
				  ...
				  $row=mysqli_fetch_array($data);
								  ...
								  $id=$row['id_berita']; // diketik user dikasih disini
								  $judul=$row['judul'];
	  ...
	  <form name="update-berita" class="form-horizontal style-form" method="post" action="update-berita.php" enctype="multipart/form-data">
									...
									<div class="form-group-inner">
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<img src="foto/berita/<?php echo "$foto"; ?>" style="width: 120px;float: left;margin-bottom: 5px;" required/>
                                                            </div>
                                                        </div>
                                     </div>
