...
<title> Halaman Edit UMKM </title>
            ...
            <div class="container-fluid">
                <div class="row">
				  ...
				  $row=mysqli_fetch_array($data);
								  ...
								  $id=$row['id']; // diketik user dikasih disini
								  $nama=$row['nama'];
								  $alamat=$row['alamat'];
	  ...
	  <form name="update-umkm" class="form-horizontal style-form" method="post" action="update-umkm.php" enctype="multipart/form-data">
                           <form class="form-horizontal" role="form">
									...
									<div class="form-group-inner">
                                                        <div class="row">
															...
															<input type="text" id="form-field-1" value="<?php echo "$id";?>" class="form-control" name="id"  required/>
                                                            </div>
                                                        </div>
                                     </div>
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<input type="text" id="form-field-1" value="<?php echo "$nama";?>" class="form-control" name="nama"  required/>
                                                            </div>
                                                        </div>
                                     </div>
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Kelurahan</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<input type="text" id="form-field-1" value="<?php echo "$kelurahan";?>" placeholder="kelurahan" class="form-control" name="kelurahan"  required/>
                                                            </div>
                                                        </div>
                                     </div>
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<input type="text" id="form-field-1" value="<?php echo "$produk";?>" placeholder="produk" class="form-control" name="produk"  required/>
                                                            </div>
                                                        </div>
                                     </div>
