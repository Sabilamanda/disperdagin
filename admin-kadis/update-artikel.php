  ...
  if($gambar != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'artikel/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                    ...
                    $query  = "UPDATE artikel SET id_artikel = '$id', judul = '$judul', penulis = '$penulis', deskripsi = '$deskripsi', gambar = '$nama_gambar_baru'";
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE artikel SET id_artikel = '$id', judul = '$judul', penulis = '$penulis', deskripsi = '$deskripsi'";
      $query .= "WHERE id_artikel = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
