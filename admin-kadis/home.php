...
<head>
    ...
    <title>Halaman Kepala Dinas DINKUMDAGIN</title>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-list">
								...
								<h3 style="color:#FFFFFF;" class="font-weight-bold">Selamat Datang di Halaman Kepala Dinas DINKUKMDAGIN Kota Bogor</h3>								
								</div>
                            </div>
                        </div>
                    </div>
...
$get1= mysqli_query($koneksi,"select * from koperasi");
$count1 = mysqli_num_rows($get1);

$get2= mysqli_query($koneksi,"select * from umkm");
$count2 = mysqli_num_rows($get2);

$get3= mysqli_query($koneksi,"select * from ikm");
$count3 = mysqli_num_rows($get3);

$get4= mysqli_query($koneksi,"select * from swalayan");
