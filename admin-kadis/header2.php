            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
						...
						<li>
                            <a href="produk.php" aria-expanded="false"><i class="fa big-icon fa-table icon-wrap"></i> <span class="mini-click-non">Produk</span></a>                            
                        </li>
						...
						<ul class="collapse dropdown-header-top">                                     
						 ...
						 <li><a href="swalayan.php" aria-expanded="false"><i class="fa fa-th sub-icon-mg"></i> <span class="mini-click-non">Toko Swalayan</span></a></li>
						</ul>
						</li>
