...
<head>
    ...
    <title>Halaman Edit Daftar Komentar</title>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
						...
						<li>
                            <a href="laporan.php" aria-expanded="false"><i class="fa big-icon fa-files-o icon-wrap"></i> <span class="mini-click-non">Cetak Laporan</span></a>               
                        </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Edit Komentar</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											  ...
											  include "koneksi.php";
													...
													$query ="SELECT b.id_berita ,judul_berita FROM berita b join komentar k on b.id_berita = k.id_berita";
												...
												$balasan_komentar=$row['balasan_komentar'];
                           ...
                           <form class="form-horizontal" role="form">
									...
									<div class="form-group">
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Balasan Komentar</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<script type="text/javascript" src="ckeditor/ckeditor.js"></script>	
																				  <textarea class="ckeditor" id="ckeditor" name="balasan_komentar" >
																				  <?php echo "$balasan_komentar" ?>
																				  </textarea></div>
                                                        </div>
                                     </div>
									 ...
									 <div class="row">
										<div class="col-sm-6">
											...
											<input type="radio" <?php if ($data['status_komentar']==1) echo "checked"; ?> class="form-check-input" name="status_komentar" value="1">Publish
											</label>
											</div>
										<div class="form-check-inline">
											<label class="form-check-label">
											<input type="radio" <?php if ($data['status_komentar']==0) echo "checked"; ?> class="form-check-input" name="status_komentar" value="0">Tidak dipublish
											</label>
										</div>
											</div>
										</div>
