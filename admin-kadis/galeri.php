                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Galeri</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x-editable-list">
							...
							<?php
								echo "<a href=tambah-galeri.php>
								<button type='button' class='btn btn-primary'><i class='fa fa-plus'></i> Tambah Galeri</button>
									</a><br><br>";?>
								   ...
								   $perintah_sql = "select * from $tabel LIMIT $startpoint , $limit";
									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
											...
											<td><img src="galeri/<?php echo $row['gambar'] ?>" alt="" width="50px" height="50px"></td>
										 <?php
										 
												echo"<td><a href=\"edit-galeri.php?id=$row[0]\"><button class='btn btn-primary btn-xs'>
													<i class='fa fa-pencil'></i></button></a></td>";
												echo"<td><a href=\"delete-galeri.php?id=$row[0]\"onclick=\"return confirm('Anda yakin akan menghapus data ini?')\">
