                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x-editable-list">
                            <div class="alert-title">
                                <h2>ADMIN</h2>
                              <?php
							   echo "<a href=tambah-admin.php>
					<button type='button' class='btn btn-primary'><i class='fa fa-plus'></i> Tambah Admin</button>
				</a><br><br>";
							  ?>
                            </div>
									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
										 ...
										 <?php
												...
												echo"<td><a href=\"edit-admin.php?id=$row[0]\"><button class='btn btn-primary btn-xs'>
													<i class='fa fa-pencil'></i></button></a></td>";
														echo"<td><a href=\"delete-admin.php?id=$row[0]\"onclick=\"return confirm('Anda yakin akan menghapus data ini?')\">
