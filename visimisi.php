      ...
      <div class="container">
		<div class="row">
          <div class="section-headline text-center">
              <h2><strong>VISI MISI KOTA BOGOR</strong></h2>
            </div>			
        </div>
		<br><br>
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                  <img src="assets/img/tuguu.jpg" width="450px" height="420px" alt="">
            ...
            <div class="well-middle">
              <div class="single-well">
                ...
                <p>
				 ...
				 <a href="#">
				  <h4 class="sec-head">Program Unggulan Kota Bogor</h4>
				 </a>
				 <p><ol><li>Pengembangan Jasa Pariwisata dan Ekonomi Kreatif
				</li>
				<li>Penguatan Spiritualitas dan Nilai Budaya Untuk Keluarga Tangguh dan Masyarakat Madani</li>
				<li>Pengembangan Tata Kelola Pemerintahan yang Kolaboratif, Transparan dan Melayani</li>
				</ol>
				</br>
				</p>
                  </div>
