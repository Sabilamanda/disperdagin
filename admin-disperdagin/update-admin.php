                  ...
                  move_uploaded_file($file_tmp, 'img/admin/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE admin SET email = '$email', username = '$username', password = '$password', foto = '$nama_gambar_baru'";
                    ...
                    if(!$result){
                      ...
                      echo "<script>alert('Data Produk berhasil diubah.');window.location='admin.php';</script>";
                    }
              } else {     
               //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                  echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='edit-admin.php';</script>";
              }
    } else {
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
