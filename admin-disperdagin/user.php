                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x-editable-list">
                            <div class="alert-title">
                                <h2>USER</h2>
                              <?php
							   echo "<a href=tambah-user.php>
					<button type='button' class='btn btn-custon-two btn-danger'><i class='fa fa-plus'></i> Tambah User</button>
				</a><br><br>";
							  ?>
                            </div>
									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
										 ...
										 <?php
												...
												echo"<td><a href=\"edit-user.php?id=$row[0]\"><button class='btn btn-danger btn-xs'>
													<i class='fa fa-pencil'></i></button></a></td>";
														echo"<td><a href=\"delete-user.php?id=$row[0]\"onclick=\"return confirm('Anda yakin akan menghapus data ini?')\">
