...
<style type="text/css">
   ...
   <div class="all-content-wrapper">
        ...
        <div class="single-product-tab-area mg-t-15 mg-b-30">
            ...
            <div class="container-fluid">
                <div class="row">
				  ...
				  $perintah_sql="select * from produkk where id_produkk=$id";

				  $data = mysqli_query($koneksi,$perintah_sql);
				  $row=mysqli_fetch_array($data);
						
				 			  
								  $id=$row['id_produkk']; // diketik user dikasih disini
	  ...
	  <form name="update-produkk" class="form-horizontal style-form" method="post" action="update-produkk.php" enctype="multipart/form-data">
                           <form class="form-horizontal" role="form">
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
															...
															<input type="text" id="form-field-1" value="<?php echo "$nama_usaha";?>" class="form-control" name="nama_usaha"  required/>
                                                            </div>
                                                        </div>
                                     </div>
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<input type="text" id="form-field-1" value="<?php echo "$jenis_usaha";?>" class="form-control" name="jenis_usaha"  required/>
                                                            </div>
                                                        </div>
                                     </div>
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<script type="text/javascript" src="ckeditor/ckeditor.js"></script>	
																				  <textarea class="ckeditor" id="ckeditor" name="alamatt" >
																				  <?php echo "$alamatt" ?>
																				  </textarea>
                                                            </div>
                                                        </div>
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<img src="foto/produkk/<?php echo "$gambarr"; ?>" style="width: 120px;float: left;margin-bottom: 5px;" required/>
                                                            </div>
                                                        </div>
                                     </div>
