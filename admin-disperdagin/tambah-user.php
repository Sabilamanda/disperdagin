                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                ...
                                                <form name="save-user" class="form-horizontal style-form" method="post" action="save-user.php" enctype="multipart/form-data" >
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<input type="text" id="form-field-1" class="form-control" name="username"  required/>
                                                            </div>
                                                        </div>
                                     </div>
									  ...
									  <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<input type="text" id="form-field-1" placeholder="*****" class="form-control" name="password"  required/>
                                                            </div>
                                                        </div>
                                     </div>									 
