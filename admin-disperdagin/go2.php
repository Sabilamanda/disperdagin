...
<head>
    <title>Halaman Cari Koperasi</title>
        ...
        <div class="single-product-tab-area mg-t-15 mg-b-30">
            ...
            <div class="container-fluid">
                <div class="row">
					...
					<button type='button' class='btn btn-custon-two btn-danger'>Kembali ke Koperasi</button>
				</a><br><br>";
							  ?>
							</div>							  
		  ...
		  if(isset($_POST['cari']))
		  {
			...
			include "koneksi.php";
			$perintah_sql="select * from koperasi where nama_koperasi like '%$qcari%'";
