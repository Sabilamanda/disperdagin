                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x-editable-list">
                            <div class="alert-title">
                                <h2>PEGAWAI</h2>
                              <?php
							   echo "<a href=tambah-pegawai.php>
					<button type='button' class='btn btn-custon-two btn-danger'><i class='fa fa-plus'></i> Tambah Pegawai</button>
				</a><br><br>";
							  ?>
                            </div>
								   ...
								   $perintah_sql = "select * from $tabel LIMIT $startpoint , $limit";
									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
											...
											<td><img src="foto/pegawai/<?php echo $row['foto'] ?>" alt="" width="50px" height="50px"></td>
											<?php
										 
										 echo"<td><a href=\"edit-pegawai.php?id=$row[0]\"><button class='btn btn-danger btn-xs'>
											 <i class='fa fa-pencil'></i></button></a></td>";
												 echo"<td><a href=\"delete-pegawai.php?id=$row[0]\"onclick=\"return confirm('Anda yakin akan menghapus data ini?')\">
