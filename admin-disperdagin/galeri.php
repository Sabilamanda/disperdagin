                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x-editable-list">
							...
							<?php
								...
								<button type='button' class='btn btn-custon-two btn-danger'><i class='fa fa-plus'></i> Tambah Galeri</button>
									</a><br><br>";?>
									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
										 ...
										 <?php
												...
												echo"<td><a href=\"edit-galeri.php?id=$row[0]\"><button class='btn btn-danger btn-xs'>
