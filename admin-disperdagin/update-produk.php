  ...
  if($gmbr != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'foto/produk/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE produk SET nama_produk = '$nama_produk', kategori = '$kategori', alamat = '$alamat', gmbr = '$nama_gambar_baru'";
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE produk SET nama_produk = '$nama_produk', kategori = '$kategori', alamat = '$alamat'";
      $query .= "WHERE id_produk = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
