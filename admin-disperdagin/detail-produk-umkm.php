...
<title> Halaman Detail Produk </title> 
        ...
        <div class="single-product-tab-area mg-t-15 mg-b-30">
            ...
            <div class="container-fluid">
                <div class="row">
				  ...
				  $perintah_sql="select * from produk where id_umkm=$id";
	  ...
	  <form name="update-produk-umkm" class="form-horizontal style-form" method="post" action="update-produk-umkm.php" enctype="multipart/form-data">
