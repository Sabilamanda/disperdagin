...
session_start();
	...
	// baru tadinya tabel produk-umkm menjadi umkm1
	$tabel = "umkm1";
?><!DOCTYPE html>
<?php
	include ('header.php');
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x-editable-list">
							...
							<?php
								echo "<a href=tambah-produk-umkm.php>
								<button type='button' class='btn btn-custon-three btn-danger'><i class='fa fa-plus'></i> Tambah Produk</button>
									</a><br><br>";?>
							...
							<tbody>
									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
										 ...
										 <td>
											  <a href="detail-produk-umkm.php?id=<?php echo $row['id_umkm']; ?>"><button class='btn btn-danger btn-xs'>
													<i class='fa fa-eye'></i></button></a></td>
											  <td><a href="edit-produk-umkm.php?id=<?php echo $row['id_umkm']; ?>">
											  <button class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></button></a></td>
											  <td><a href="delete-produk-umkm.php?id=<?php echo $row['id_umkm']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">
