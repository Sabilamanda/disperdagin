...
<title> Halaman Detail Produk </title> 
        ...
        <div class="single-product-tab-area mg-t-15 mg-b-30">
            ...
            <div class="container-fluid">
                <div class="row">
				  ...
				  $perintah_sql="select * from produk where id_produk=$id";

				  $data = mysqli_query($koneksi,$perintah_sql);
				  $row=mysqli_fetch_array($data);
						
				 			  
								  $id=$row['id_produk']; // diketik user dikasih disini
	  ...
	  <form name="update-produk" class="form-horizontal style-form" method="post" action="update-produk.php" enctype="multipart/form-data">
                           <form class="form-horizontal" role="form">
									 ...
									 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<img src="foto/produk/<?php echo "$gmbr"; ?>" style="width: 400px; height: 250px; float: left;margin-bottom: 5px;" required/>
                                                            </div>
                                                        </div>
                                     </div>
