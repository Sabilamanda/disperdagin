                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x-editable-list">
							...
							<?php
								echo "<a href=tambah-produkk.php>
							...
							<tbody>
									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
											...
											<td><?php echo $row['alamatt']; ?></td>											
											<td><img src="foto/produkk/<?php echo $row['gambarr'] ?>" alt="" width="50px" height="50px"></td>
										 <td>
											  <a href="edit-produkk.php?id=<?php echo $row['id_produkk']; ?>"><button class='btn btn-primary btn-xs'>
																					<i class='fa fa-pencil'></i></button></a></td>
											  <td><a href="delete-produkk.php?id=<?php echo $row['id_produkk']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">
