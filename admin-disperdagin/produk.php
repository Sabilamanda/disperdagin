									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
										 ...
										 <td>
											  ...
											  <td><a href="edit-produk.php?id=<?php echo $row['id_produk']; ?>">
											  <button class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></button></a></td>
											  <td><a href="delete-produk.php?id=<?php echo $row['id_produk']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">
