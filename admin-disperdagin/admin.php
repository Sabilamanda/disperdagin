        ...
        <div class="single-product-tab-area mg-t-15 mg-b-30">
            ...
            <div class="container-fluid">
                <div class="row">
					...
					<button type='button' class='btn btn-custon-three btn-danger'><i class='fa fa-plus'></i> Tambah Admin</button>
				</a><br><br>";
							  ?>
                            </div>
								   ...
								   $perintah_sql = "select * from $tabel LIMIT $startpoint , $limit";
									...
									while($row=mysqli_fetch_array($data)){
										...
										<tr>
											...
											<td style="text-align: center;"><img src="img/admin/<?php echo $row['foto']; ?>" style="width: 60px;"></td>
										 <?php
										 
												echo"<td><a href=\"edit-admin.php?id=$row[0]\"><button class='btn btn-danger btn-xs'>
